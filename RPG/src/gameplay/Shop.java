        ...
        while(quit == false && direction != 1)
        {
            ...
            while(selection == false && (direction != 1))
          {
           ...
           if(UDDirection == 1 || UDDirection == 3 || UDDirection == 5)
            ...
            run.append("Sell " + Player.armorSet[Player.equippedArmor].name + " for: " + Player.armorSet[Player.equippedArmor].price/2 + " gold");
            run.append("\n[def:" + Player.armorSet[Player.equippedArmor].def + "]");
            run.append("\n_________________________________________________________________________________________________________________________");
          ...
          {
              Player.gold = Player.gold + Player.armorSet[Player.equippedArmor].price/2;
              armor.None.setArmor();
            } 
        }  
       }
