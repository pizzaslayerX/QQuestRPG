...
public class VirulentPlague extends Special
{
    ...
    public VirulentPlague() throws InterruptedException
    {
        super(name,desc,atkDesc,dmg,pureDmg,doesDmg,statusEffect,limit,use,useTurn,statusVal,heal,manaCost,percentHeal,targetAll,110);
    }
    
    public static void equip() throws InterruptedException {
    	Player.abilities.add(new VirulentPlague());
    }
