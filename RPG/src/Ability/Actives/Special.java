...
public abstract class Special implements Serializable{
    ...
    public Special(String n, String dc, String ad,int d,boolean pd,boolean dd,boolean s,boolean l,boolean u,boolean ut,int[]sv,int h,int m,int ph,boolean t,int co) throws InterruptedException {
