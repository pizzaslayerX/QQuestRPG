...
public class ItemManager
{
  ...
  public static void newItem(boolean h, boolean s, boolean e, int hu, int su, String n,String d,boolean m)
   ...
   public static void useItems(int i)
   {
       ...
       if(i == 1)
       {
          ...
          if(marine1 == true)
          {
              ...
              Main.Player.mana = Main.Player.mana + (Main.Player.maxMana / 2);
              pause(3000);
               MainFightPanel.clearDisplay();
           }
          if(heal1 == true)
          {
              ...
              MainFightPanel.append(MainFightPanel.user,itemSlot[0].substring(itemSlot[0].indexOf(" |")));
              Main.Player.health = Main.Player.health + (int)(Main.Player.maxHealth * (healUp1 / 100.0));
       ...
       else if(i == 2)
       {
           ...
           if(heal2 == true)
          {
              ...
              Main.Player.health = Main.Player.health + (int)(Main.Player.maxHealth * (healUp2 / 100.0));
              if(Main.Player.health > Main.Player.maxHealth)
              {
                  Main.Player.health = Main.Player.maxHealth;
              }
       ...
       else if (i == 3)
       {
           ...
           if(heal3 == true)
          {
              ...
              Main.Player.health = Main.Player.health + (int)(Main.Player.maxHealth * (healUp3 / 100.0));
              if(Main.Player.health > Main.Player.maxHealth)
              {
                  Main.Player.health = Main.Player.maxHealth;
              }
    ...
    else if (i == 4 && slot4unlock == true)
       {
           ...
           if(heal4 == true)
          {
              ...
              Main.Player.health = Main.Player.health + (int)(Main.Player.maxHealth * (healUp4 / 100.0));
              if(Main.Player.health > Main.Player.maxHealth)
              {
                  Main.Player.health = Main.Player.maxHealth;
              }
    ...
    else if (i == 5 && slot5unlock == true)
    {
        ...
        if(heal5 == true)
       {
           ...
           Main.Player.health = Main.Player.health + (int)(Main.Player.maxHealth * (healUp5 / 100.0));
           if(Main.Player.health > Main.Player.maxHealth)
           {
               Main.Player.health = Main.Player.maxHealth;
           }
   ...
   public static void setItem() throws InterruptedException
   {
      ...
      else if(!((itemSlot[0].equals("none")) && itemSlot[1].equals("none") && itemSlot[2].equals("none")&& itemSlot[3].equals("none")) && itemSlot[4].equals("none") && slot5unlock == true)
      {
       ...
       else
       {
        ...
        Main.Player.userWait();
        run.output.setText("");
       }
       if(Main.Shop.shopOpen == true)
            run.fontSize(30);
       full = false;
     }
   ...
   public static int fightPrintItems() {
	   ...
	   for(int i = 1;i<=slotCount+1;i++) {
		   ...
		   if(direction == i && i < slotCount+1)
			   MainFightPanel.append(MainFightPanel.user,Item.ItemManager.itemSlot[i-1] + "\n",Color.WHITE,20,true);
   ...
   public static void printItems()
   {
       ...
       {
           run.append("\n[" + (i+1) +"]: " + Item.ItemManager.itemSlot[i]); 
       }
       run.append("\n====================================\n");
    }
